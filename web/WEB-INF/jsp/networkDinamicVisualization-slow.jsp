    ...
    <body>
        ...
        <div id="second-div" class="row">
            ...
            <div class="col-md-12" style="font-size: 22px">
                <input type="radio" name="op" id="noOP" value="0" onchange="noOperon()" checked> No operon information<br>
                <input type="radio" name="op" id="opCo" value="1" onchange="operonsCombined()"> Operons combined<br>
            </div>
        </div>

        <div id="third-div" class="row" style="margin-top: 20px;">
            <div  class="col-md-12 font">
                <button id="stop-layout-button" class="btn btn-primary btn-normal" onclick="layoutStatus()">Stop Layouting</button>
            </div>
        </div>
        ...
        <script>
            ...
            var loaderPosition = (screenWidth / 2) - 300;
        ...
        <div class="container-fluid font">
            ...
            <c:forEach var="gi" items="${genesInfo}">
                <script>
                    ...
                    //console.log(geneObject);
                    if (!geneInfoMapCombined.get(geneObject.operon)) {
                        ...
                        if (geneObject.pos == "0") {
                            ...
                            geneInfoMapCombined.set(key, geneObject);
                        } else {
                            //console.log(geneObject);
                            //console.log(geneObject.operon);
                            var belongToOperon = operons.get(geneObject.operon);
                            ...
                            //console.log("geneObject:");
                            //console.log(geneObject);
                            geneObject.locusTag = geneObject.operon;
                            geneObject.name = geneObject.operon;
                            geneObject.proteinId = "-";
                            geneObject.operon = "operon";
                            geneObject.genes = belongToOperon.genes;
                            key = geneObject.name;
            ...
            <c:forEach items="${regulationsView}" var="ri">
                ...
                <script>
                    ...
                    if (tf != null) {
                        ...
                        if ('${ri.transcriptionFactor.name}' != "") {
                            //                      console.log("source: " + '${ri.transcriptionFactor.name}');
                    ...
                    //           console.log(geneInfoMapCombined.get(regInteraction.tfName).name);
            ...
            <script>
                ...
                function  noOperons() {
                    ...
                    for (var i = 0; i < regInteractions.length; i++) {
                        ...
                        if (regInteractions[i].riRole == "R") {
                            edgeColor = '#ff6666';
                            riRole = "Repressor";
                        } else if (regInteractions[i].riRole == "A") {
                            edgeColor = '#349834';
                            riRole = "Activator";
                        } else if (regInteractions[i].riRole == "S") {
                            edgeColor = '#00b3b3';
                            riRole = "Sigma";
                        } else if (regInteractions[i].riRole == "D") {
                            edgeColor = '#0080ff';
                            riRole = "Dual";
                        }
                    ...
                    mapNodes.forEach(mapNode => {
                        ...
                        if (geneInfo.role == "Repressor") {
                            //console.log("mapNode.role: " + geneInfo.role)
                            nodeColor = "#ff8080";
                        } else if (geneInfo.role == "Activator") {
                            //console.log("mapNode.role: " + geneInfo.role)
                            nodeColor = "#67cb67";
                        } else if (geneInfo.role == "Dual") {
                            //console.log("mapNode.role: " + geneInfo.role)
                            nodeColor = "#80b3ff";
                        } else if (geneInfo.role == "Sigma") {
                            //console.log("mapNode.role: " + geneInfo.role)
                            nodeColor = "#66d9ff";
                        }
                    ...
                    network.stabilize(2000);   // 100 works for me, YMMV
                }
                ...
                function operonsCombined2() {
                    ...
                    for (var i = 0; i < regInteractionsCombined.length; i++) {
                        ...
                        if (regInteractionsCombined[i].riRole == "R") {
                            edgeColor = '#ff6666';
                            riRole = "Repressor";
                        } else if (regInteractionsCombined[i].riRole == "A") {
                            edgeColor = '#349834';
                            riRole = "Activator";
