 ...
 * @author mariana
 */
public class RegulatorsRegulationsTest {
...
//      Total in experimental database
        ...
        numOfActivators += geneDAO.findNumberOfTFsModelOrganismsByRole("Activator") == null ? null : Math.toIntExact(geneDAO.findNumberOfTFsModelOrganismsByRole("Activator"));
        ...
        numOfRepressors += geneDAO.findNumberOfTFsModelOrganismsByRole("Repressor") == null ? null : Math.toIntExact(geneDAO.findNumberOfTFsModelOrganismsByRole("Repressor"));
        ...
        activations += riDAO.bringNumberOfRIsByRole("Activator") == null ? null : Math.toIntExact(riDAO.bringNumberOfRIsByRole("Activator"));
        System.out.println("activations: " + activations);
        ...
        repressions += riDAO.bringNumberOfRIsByRole("Repressor") == null ? null : Math.toIntExact(riDAO.bringNumberOfRIsByRole("Repressor"));
        System.out.println("repressions: " + repressions);
//                    System.out.println("numOfRis: " + numOfRis);
        ...
        if (regulatorsRegulationsAux != null) {
            System.out.println("Delete regulatorsRegulationsAux");
            rrDAO.delete(regulatorsRegulationsAux);
        }

        try {
            System.out.println("Save regulatorsRegulations");
...
//      Total in predicted database
        ...
        numOfActivators += geneDAO.findNumberOfTFsByRole("Activator") == null ? null : Math.toIntExact(geneDAO.findNumberOfTFsByRole("Activator"));
        System.out.println("numOfActivators: " + numOfActivators);
        ...
        numOfRepressors += geneDAO.findNumberOfTFsByRole("Repressor") == null ? null : Math.toIntExact(geneDAO.findNumberOfTFsByRole("Repressor"));
        System.out.println("numOfRepressors: " + numOfRepressors);
...
//                    System.out.println("repressions: " + repressions);
                ...
                if (numOfActivators != 0 && numOfDuals != 0 && numOfRepressors != null) {
                    ...
                    regulatorsRegulationsAux = new RegulatorsRegulations();
                    regulatorsRegulationsAux = rrDAO.findByOrganism(regulatorsRegulations.getGenome().getId());
                    if (regulatorsRegulationsAux != null) {
                        rrDAO.delete(regulatorsRegulationsAux);
                    }
                    try {
