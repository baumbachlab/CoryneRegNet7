<%-- 
    Document   : predictedData
    Created on : Nov 11, 2018, 7:14:39 PM
    Author     : doglas
--%>
...
<html>
    ...
    <div class="container-fluid badge badge-light space-to-footer">
        ...
        <div class="row">
            <div class="col-sm-12">
                <table id="predicted-data" class="table table-striped text-center" style="width:100%">
                            ...
                            <tr>
                                ...
                                <th>${g.product}</th>
                                    <c:choose>
                                        ...
                                        <th><span><a href="operonInfo.htm?name=${opName}&type=predicted">${opName}</a></span></th>            
                                                </c:otherwise>
                                            </c:choose>
