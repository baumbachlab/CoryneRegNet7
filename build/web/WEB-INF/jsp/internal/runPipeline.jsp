<%-- 
    Document   : runPipeline
    Created on : Mar 4, 2019, 1:08:52 PM
    Author     : mariana
--%>
        ...
        <form action="setThresholds.htm" method="POST">
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <div class="row">
                                <div class="checkbox" id="templateOrganisms">
                                    <label><input type="checkbox" name="templateList" value="all" onclick="checkFormData()"> All template organisms</label><br>
                                        <c:forEach items="${generaNamesTemplate}" var="generaName">
                                        <label class="italic"><input type="checkbox" name="templateList" value="${generaName}" onclick="checkFormData()"> ${generaName}</label><br>
                                        </c:forEach>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="row">
                                <div class="checkbox" id="targetOrganisms">
                                    <label><input type="checkbox" name="targetList" id="targetList" value="all" onclick="checkFormData()"> All target organisms</label><br>
                                        <c:forEach items="${generaNamesTarget}" var="generaName">
                                        <label class="italic"><input type="checkbox" id="targetList" name="targetList" value="${generaName}" onclick="checkFormData()"> ${generaName}</label><br>
                                        </c:forEach>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-sm-12" id="submitdiv">
                 ...
                 <div class="col-sm-12">
                    <a class="btn btn-primary" href="testAssync.htm" role="button">testAssync</a>
                </div>
                 <div class="col-sm-12">
                    <a class="btn btn-primary" href="testExecuter.htm" role="button">testExecuter</a>
                </div>
                  <div class="col-sm-12">
                    <a class="btn btn-primary" href="testAssync2.htm" role="button">testAssync2</a>
                </div>
            </div>
        </form>
    </div>
