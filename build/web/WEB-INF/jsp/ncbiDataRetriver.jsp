...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="css/ncbiDataRetriver.css">
    ...
    <nav class="navbar navbar-expand-lg navbar-inverse bg-dark fixed-top navbar-dark">
    ...
    <div class="container-fluid">
        <div class="row search-database">
            <div class="col-sm-12 font">
                <div class="title-size text-center centered-top">Retrive genomic data from NCBI</div>
            </div>
        </div>
    </div>
